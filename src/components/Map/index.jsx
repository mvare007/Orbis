...
const MapBox = ({ center, zoom, selectedCountry }) => {
  const Map = ReactMapboxGl({
    accessToken:
      "pk.eyJ1IjoibXZhcmUwMDciLCJhIjoiY2s2Y2FocWI3MDBobTNrbXdhZ3pmZnRiOCJ9.F0JHDGeqdYEJrB-XCJHr9Q",
  });
  ...
  const mapboxStyle = [
    "mapbox://styles/davidchopin/cjtz90km70tkk1fo6oxifkd67",
  ...
  return (
    ...
    >
      ...
      <Layer
        ...
        filter={
          ("countries",
          ["in", "ADM0_A3_IS"].concat([selectedCountry.alpha3Code || ""]))
        }
        type="fill"
        paint={{
          "fill-color": "#f9cb40",
